...
class _VenturiTubeScreenPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawArrow(
      canvas,
      Offset(x0 + 6, arrowY),
      Offset(x0 + 6 + v1 * 2.2, arrowY),
      const Color(0xFF00D4FF),
      1.5,
    );
    _label(
      canvas,
      'v₁=${v1.toStringAsFixed(1)}',
      Offset(x0 + 4, arrowY - wideHalf - 13),
      const Color(0xFF00D4FF),
      8,
    );
    ...
    _label(
      canvas,
      'v₂=${v2.toStringAsFixed(1)}',
      Offset(narX - 12, arrowY - narrowHalf - 13),
      const Color(0xFFFF6B35),
      8,
    );
    ...
    canvas.drawRect(
      Rect.fromLTWH(g1X - 6, g1TopY - p1MaxH, 12, p1MaxH),
      Paint()..color = const Color(0xFF001830).withValues(alpha: 0.7),
    );
    canvas.drawRect(
      Rect.fromLTWH(g1X - 5, g1TopY - p1H, 10, p1H),
    ...
    _label(
      canvas,
      'P₁',
      Offset(g1X - 5, g1TopY - p1MaxH - 12),
      const Color(0xFF00D4FF),
      9,
    );
    _label(
      canvas,
      (p1 / 1000).toStringAsFixed(1),
      Offset(g1X - 10, g1TopY - p1H - 11),
    ...
    canvas.drawRect(
      Rect.fromLTWH(g2X - 6, g2TopY - p1MaxH, 12, p1MaxH),
      Paint()..color = const Color(0xFF001830).withValues(alpha: 0.7),
    );
    final p2HClamped = p2H.clamp(0.0, p1MaxH);
    canvas.drawRect(
      Rect.fromLTWH(g2X - 5, g2TopY - p2HClamped, 10, p2HClamped),
      Paint()..color = const Color(0xFF0060C0).withValues(alpha: 0.85),
    );
    canvas.drawRect(
      Rect.fromLTWH(g2X - 6, g2TopY - p1MaxH, 12, p1MaxH),
    ...
    _label(
      canvas,
      'P₂',
      Offset(g2X - 5, g2TopY - p1MaxH - 12),
      const Color(0xFFFF6B35),
      9,
    );
    _label(
      canvas,
      (p2 / 1000).toStringAsFixed(1),
      Offset(g2X - 10, g2TopY - p2HClamped - 11),
      const Color(0xFFE0F4FF),
      7,
    );
    ...
    _label(
      canvas,
      'P₁=${(p1 / 1000).toStringAsFixed(1)}kPa  P₂=${(p2 / 1000).toStringAsFixed(1)}kPa  v₂=${v2.toStringAsFixed(1)}m/s',
      Offset(w / 2 - 65, eqY + 12),
      const Color(0xFFE0F4FF),
      8,
    );
  }
