...
class _SpecificHeatScreenPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawContainer(
      ...
      canvas.drawRRect(
        RRect.fromRectAndRadius(
          Rect.fromLTWH(tmX - 3, tmTop2, 6, tmH),
      ...
      _drawLabel(
        canvas,
        subLabel,
        Offset(cx, fillTop - 26),
        const Color(0xFF5A8A9A),
        8,
      );
      _drawLabel(
        canvas,
        '+${deltaT.toStringAsFixed(1)}K',
        Offset(tmX + 18, tmTop2 + tmH * 0.5),
    ...
    drawContainer(
      ...
      const Color(0xFF00D4FF),
      '물 (H₂O)',
      'c = ${specificHeat.toStringAsFixed(0)} J/kg·K',
    );
    drawContainer(
      metalCx,
      metalDeltaT,
    ...
    canvas.drawPath(
      metalPath,
      Paint()
        ..color = const Color(0xFF64FF8C).withValues(alpha: 0.8)
        ..strokeWidth = 1.5
        ..style = PaintingStyle.stroke,
    );
    ...
    _drawLabel(
      canvas,
      '물',
      Offset(gLeft + gW * 0.3, gBot - gH * 0.25),
      const Color(0xFF00D4FF),
      8,
    );
    _drawLabel(
      canvas,
      '금속',
      Offset(gLeft + gW * 0.15, gBot - gH * 0.7),
      const Color(0xFF64FF8C),
      8,
    );
