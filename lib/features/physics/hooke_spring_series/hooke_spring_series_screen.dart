      ...
      body: SingleChildScrollView(
        ...
        child: SimulationContainer(
          ...
          simulation: SizedBox(
            height: 350,
            child: CustomPaint(
              painter: _HookeSpringScreenPainter(time: _time, k1: _k1, k2: _k2),
              size: Size.infinite,
            ),
          ),
          controls: Column(
...
class _HookeSpringScreenPainter extends CustomPainter {
  ...
  void _arrow(Canvas canvas, Offset from, Offset to, Color color, double sw) {
    ...
    canvas.drawLine(
      to,
      Offset(to.dx - nx * hs - ny * hs * 0.5, to.dy - ny * hs + nx * hs * 0.5),
      p,
    );
    canvas.drawLine(
      to,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Wall
    canvas.drawRect(
      Rect.fromLTWH(seriesX - 20, wallY - 4, 40, 5),
      Paint()..color = const Color(0xFF1A3040),
    );
    canvas.drawLine(
      Offset(seriesX - 20, wallY - 4),
      Offset(seriesX + 20, wallY - 4),
      Paint()
    ...
    _label(
      canvas,
      'k₁=${k1.toStringAsFixed(0)}',
      Offset(seriesX + 13, (springTop + seriesMidY) / 2 - 5),
      const Color(0xFF00D4FF),
      8,
    );
    ...
    _label(
      canvas,
      'k₂=${k2.toStringAsFixed(0)}',
      Offset(seriesX + 13, (seriesMidY + seriesEndY) / 2 - 5),
      const Color(0xFF00D4FF),
      8,
    );
    ...
    // Mass block
    canvas.drawRect(
      Rect.fromLTWH(seriesX - 12, seriesEndY, 24, 16),
      Paint()
    ...
    _arrow(
      canvas,
      Offset(seriesX, seriesEndY + 16),
      Offset(seriesX, seriesEndY + 16 + force * 0.4),
    ...
    _label(
      canvas,
      'F',
      Offset(seriesX + 4, seriesEndY + 22),
      const Color(0xFFFF6B35),
      8,
    );
    ...
    _label(
      canvas,
      '1/k_s=1/k₁+1/k₂',
      Offset(seriesX - 34, seriesEndY + 38),
      const Color(0xFF5A8A9A),
      8,
    );
    _label(
      canvas,
      'k_s=${kSeries.toStringAsFixed(1)} N/m',
      Offset(seriesX - 20, seriesEndY + 50),
    ...
    // === PARALLEL SIDE (right) ===
    canvas.drawRect(
      Rect.fromLTWH(parallelX - 30, wallY - 4, 60, 5),
      Paint()..color = const Color(0xFF1A3040),
    );
    canvas.drawLine(
      Offset(parallelX - 30, wallY - 4),
      Offset(parallelX + 30, wallY - 4),
      Paint()
        ..color = const Color(0xFF5A8A9A)
        ..strokeWidth = 2,
    ...
    canvas.drawLine(
      Offset(sp1X, springTop),
      Offset(sp2X, springTop),
      Paint()
        ..color = const Color(0xFF5A8A9A)
        ..strokeWidth = 1.5,
    );
    ...
    _label(
      canvas,
      'k₁',
      Offset(sp1X - 18, (springTop + parEndY) / 2 - 5),
      const Color(0xFFFF6B35),
      8,
    );
    ...
    _label(
      canvas,
      'k₂',
      Offset(sp2X + 5, (springTop + parEndY) / 2 - 5),
      const Color(0xFFFF6B35),
      8,
    );
    ...
    canvas.drawRect(
      Rect.fromLTWH(parallelX - 14, parEndY, 28, 16),
      Paint()
        ..color = const Color(0xFF1A3040)
        ..style = PaintingStyle.fill,
    );
    ...
    _arrow(
      canvas,
      Offset(parallelX, parEndY + 16),
      Offset(parallelX, parEndY + 16 + force * 0.4),
      const Color(0xFFFF6B35),
      1.5,
    );
    _label(
    ...
    _label(
      canvas,
      'k_p=k₁+k₂',
      Offset(parallelX - 26, parEndY + 38),
      const Color(0xFF5A8A9A),
      8,
    );
    _label(
      canvas,
      'k_p=${kParallel.toStringAsFixed(1)} N/m',
      Offset(parallelX - 22, parEndY + 50),
      const Color(0xFFE0F4FF),
      8,
      bold: true,
    );
