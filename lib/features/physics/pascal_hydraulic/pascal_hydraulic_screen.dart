...
class _PascalHydraulicScreenPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final largePistonRise =
        smallPistonDisp * (a1 / a2); // large piston rises less
    ...
    _drawLabel(
      canvas,
      'P₁ = P₂',
      Offset(w * 0.47, pressureY),
      const Color(0xFFE0F4FF).withValues(alpha: 0.7),
      8,
    );

    // --- Small cylinder walls ---
    canvas.drawLine(
      Offset(scCx - scW / 2, scTop),
      Offset(scCx - scW / 2, scBot),
      wallPaint,
    );
    canvas.drawLine(
      Offset(scCx + scW / 2, scTop),
    ...
    // U-tube bottom
    canvas.drawLine(
      Offset(scCx - scW / 2, uBot),
      Offset(lcCx + lcW / 2, uBot),
      wallPaint,
    );
    canvas.drawLine(
      Offset(scCx - scW / 2, uTop),
      Offset(scCx - scW / 2, uBot),
      wallPaint..color = const Color(0xFF5A8A9A).withValues(alpha: 0.4),
    );
    canvas.drawLine(
      Offset(lcCx + lcW / 2, uTop),
      Offset(lcCx + lcW / 2, uBot),
      wallPaint..color = const Color(0xFF5A8A9A).withValues(alpha: 0.4),
    );
    ...
    canvas.drawLine(
      Offset(lcCx - lcW / 2, lcTop),
      Offset(lcCx - lcW / 2, lcBot),
      wallPaint..color = const Color(0xFF5A8A9A).withValues(alpha: 0.8),
    );
    canvas.drawLine(
      Offset(lcCx + lcW / 2, lcTop),
      Offset(lcCx + lcW / 2, lcBot),
    ...
    canvas.drawLine(
      Offset(scCx, scTop - 6),
      Offset(scCx, scTop - 6 - f1ArrowLen),
      Paint()
        ..color = const Color(0xFFFF6B35)
        ..strokeWidth = 2,
    );
    canvas.drawLine(
      Offset(scCx - 4, scTop - 6 - f1ArrowLen + 8),
      Offset(scCx, scTop - 6 - f1ArrowLen),
      Paint()
        ..color = const Color(0xFFFF6B35)
        ..strokeWidth = 2,
    ...
    _drawLabel(
      canvas,
      'F₁=${force1.toStringAsFixed(0)}N',
      Offset(scCx, scTop - f1ArrowLen - 16),
    ...
    canvas.drawLine(
      Offset(lcCx, lcTop - 6),
      Offset(lcCx, lcTop - 6 - f2ArrowLen),
      Paint()
        ..color = const Color(0xFF64FF8C)
        ..strokeWidth = 3,
    );
    canvas.drawLine(
      Offset(lcCx - 5, lcTop - 6 - 8),
      Offset(lcCx, lcTop - 6),
      Paint()
        ..color = const Color(0xFF64FF8C)
        ..strokeWidth = 3,
    ...
    _drawLabel(
      canvas,
      'F₂=${force2.toStringAsFixed(0)}N',
      Offset(lcCx, lcTop - f2ArrowLen - 16),
    ...
    _drawLabel(
      canvas,
      '= ${force2.toStringAsFixed(0)} N  (${areaRatio.toStringAsFixed(0)}x 증폭)',
      Offset(w / 2, h * 0.95),
  ...
  @override
  bool shouldRepaint(covariant _PascalHydraulicScreenPainter oldDelegate) =>
      true;
}
