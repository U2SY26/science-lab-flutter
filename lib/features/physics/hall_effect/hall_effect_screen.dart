...
class _HallEffectScreenPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
      ...
      for (int c = 0; c < bCols; c++) {
        ...
        canvas.drawCircle(
          ...
          Paint()
            ..color = const Color(
              0xFF00D4FF,
            ).withValues(alpha: 0.25 + bField * 0.15),
        );
        canvas.drawCircle(
          Offset(bx, by),
          1.2,
          Paint()
            ..color = const Color(
              0xFF00D4FF,
            ).withValues(alpha: 0.6 + bField * 0.2),
        );
      }
    }
    ...
    // Current arrows
    canvas.drawLine(
      Offset(condLeft - 22, condCy),
      Offset(condLeft, condCy),
      Paint()
        ..color = const Color(0xFFFF6B35)
        ..strokeWidth = 2,
    );
    canvas.drawLine(
      Offset(condLeft - 8, condCy - 5),
      Offset(condLeft, condCy),
      Paint()
        ..color = const Color(0xFFFF6B35)
        ..strokeWidth = 2,
    ...
    _drawLabel(
      canvas,
      'I',
      Offset(condLeft - 30, condCy),
      const Color(0xFFFF6B35),
      10,
    );

    canvas.drawLine(
      Offset(condRight, condCy),
      Offset(condRight + 22, condCy),
      Paint()
        ..color = const Color(0xFFFF6B35)
        ..strokeWidth = 2,
    );
    canvas.drawLine(
      Offset(condRight + 16, condCy - 5),
      Offset(condRight + 22, condCy),
      Paint()
        ..color = const Color(0xFFFF6B35)
        ..strokeWidth = 2,
    ...
    canvas.drawLine(
      Offset(w * 0.85, condTop),
      Offset(w * 0.85, condTop - 20),
      Paint()
        ..color = const Color(0xFF64FF8C)
        ..strokeWidth = 1.5,
    );
    canvas.drawLine(
      Offset(w * 0.85, condBottom),
      Offset(w * 0.85, condBottom + 20),
      Paint()
        ..color = const Color(0xFF64FF8C)
        ..strokeWidth = 1.5,
    );
    ...
    _drawLabel(
      canvas,
      'V_H',
      Offset(condLeft - 28, condCy - condH * 0.3),
      const Color(0xFF64FF8C),
      9,
    );
    // Vertical double-arrow
    canvas.drawLine(
      Offset(condLeft - 28, condTop + 8),
      Offset(condLeft - 28, condBottom - 8),
      Paint()
    ...
    canvas.drawLine(
      Offset(w * 0.5, condCy),
      Offset(w * 0.5, condBottom - 8),
      Paint()
        ..color = const Color(0xFFFF6B35).withValues(alpha: 0.6)
        ..strokeWidth = 1.5,
    );
    canvas.drawLine(
      Offset(w * 0.5 - 4, condBottom - 16),
      Offset(w * 0.5, condBottom - 8),
      Paint()
        ..color = const Color(0xFFFF6B35).withValues(alpha: 0.6)
        ..strokeWidth = 1.5,
    ...
    _drawLabel(
      canvas,
      'I=${currentVal.toStringAsFixed(1)}A  B=${bField.toStringAsFixed(2)}T',
      Offset(w * 0.70, h * 0.84),
