                ...
                child: Row(
                  children: [
                    ...
                    _V(
                      'λ',
                      (_bandGap > 0
                          ? '${(1240 / _bandGap).toStringAsFixed(0)} nm'
                          : '∞'),
                    ),
                  ],
                ),
...
class _BandStructureScreenPainter extends CustomPainter {
  ...
  _BandStructureScreenPainter({required this.time, required this.bandGap});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _label(
      canvas,
      'k',
      Offset(rRight - 8, rBot + 2),
      color: const Color(0xFF5A8A9A),
    );
    _label(
      canvas,
      'E',
      Offset(rLeft - 12, rTop),
      color: const Color(0xFF5A8A9A),
    );
    _label(
      canvas,
      '-π/a',
      Offset(rLeft - 8, rBot + 2),
      color: const Color(0xFF5A8A9A),
      fontSize: 8,
    );
    _label(
    ...
    canvas.drawPath(
      vbFill,
      Paint()..color = const Color(0xFF64FF8C).withValues(alpha: 0.15),
    );
    ...
    if (bandGap > 0.05) {
      ...
      canvas.drawRect(
        gapRect,
        Paint()..color = const Color(0xFF1A3040).withValues(alpha: 0.5),
      );
      // Gap label
      _label(
        canvas,
        'Eg=${bandGap.toStringAsFixed(1)}eV',
    ...
    _label(
      canvas,
      '전도대',
      Offset(rLeft + 2, eToY(ecBot + (ecTop - ecBot) * 0.25)),
      color: const Color(0xFF00D4FF),
      fontSize: 8,
    );
    _label(
      canvas,
      '가전자대',
      Offset(rLeft + 2, eToY(evTop * 0.6)),
      color: const Color(0xFF64FF8C),
      fontSize: 8,
    );

    // Material type
    final matType = bandGap < 0.05
        ? '도체'
        : bandGap < 3.5
        ? '반도체'
        : '부도체';
