...
class _FossilFormationScreenPainter extends CustomPainter {
  ...
  _FossilFormationScreenPainter({required this.time, required this.ageMya});
  ...
  @override
  bool shouldRepaint(covariant _FossilFormationScreenPainter oldDelegate) =>
      true;
}
