...
class HurricaneFormationScreen extends StatefulWidget {
  ...
  @override
  State<HurricaneFormationScreen> createState() =>
      _HurricaneFormationScreenState();
}
...
class _HurricaneFormationScreenPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawLabel(
      canvas,
      '${windSpeed2.toStringAsFixed(0)} km/h',
      Offset(cx, h * 0.12 + 16),
    ...
    _drawLabel(
      canvas,
      '나선형\n구름대',
      Offset(cx + maxR * 0.55, cy - maxR * 0.28),
      color: const Color(0xFF5A8A9A),
      fontSize: 8,
    );
    _drawLabel(
      canvas,
      'SST ${sst.toStringAsFixed(0)}°C',
      Offset(w * 0.12, h * 0.9),
  ...
  @override
  bool shouldRepaint(covariant _HurricaneFormationScreenPainter oldDelegate) =>
      true;
}
