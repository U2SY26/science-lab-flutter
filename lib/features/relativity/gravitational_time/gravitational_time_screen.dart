...
class GravitationalTimeScreen extends StatefulWidget {
  ...
  @override
  State<GravitationalTimeScreen> createState() =>
      _GravitationalTimeScreenState();
}
...
class _GravitationalTimeScreenPainter extends CustomPainter {
  ...
  _GravitationalTimeScreenPainter({required this.time, required this.radius});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      Rect.fromLTWH(leftCx, clockCy - clockR, rightCx - leftCx, clockR * 2),
      wellPaint,
    );
    ...
    _drawPhotonArrow(
      canvas,
      Offset(leftCx + clockR + 6, arrowY1 + 6),
      Offset(rightCx - clockR - 6, arrowY1 - 6),
      const Color(0xFFFF6B35),
      true,
      time,
    );
    ...
    _drawPhotonArrow(
      canvas,
      Offset(rightCx - clockR - 6, arrowY2 - 6),
      Offset(leftCx + clockR + 6, arrowY2 + 6),
    ...
    _drawLabel(
      canvas,
      'γ = ${gamma.toStringAsFixed(4)}×',
      Offset(midX - 28, ratioY),
      12,
  ...
  void _drawClock(
    ...
    for (int i = 0; i < lines.length; i++) {
      _drawLabel(
        canvas,
        lines[i],
        Offset(center.dx - 22, center.dy + r + 6 + i * 14),
        9,
        accentColor,
      );
    }
  ...
  @override
  bool shouldRepaint(covariant _GravitationalTimeScreenPainter oldDelegate) =>
      true;
}
